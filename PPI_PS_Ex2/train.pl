...
# Gist SVM
#*********
system "./gist-train-svm.exe -train tr_examples.txt -class tr_labels.txt -threshold 1e-10 -radial -holdout 100 > traingist.s";
system "perl score-svm-results.exe traingist.s";
